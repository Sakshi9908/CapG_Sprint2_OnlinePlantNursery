...
export default function Home() {
  return <div className="Homebody">
    ...
    <div className="Banner2">
      ...
      <div class="card" >
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPMNBn6WZ3l6ULovR2LsAgD6yDbdbyC340Vg&usqp=CAU" class="card-img-top" alt="..." />
        <div class="card-body">
      ...
      <div class="card" >
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeS5P4ADKKVoFTmJbmr94YYChqJGyFKfuF1g&usqp=CAU" class="card-img-top" alt="..." />
        <div class="card-body">
      ...
      <div class="card" >
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTn0rMyuOaYzhgZE1X3NtQEB81AWt2-DI7r_g&usqp=CAU" class="card-img-top" alt="..." />
        <div class="card-body">
    ...
    <div className="Banner3">
      ...
      <div class="b3card" >
        <img src="https://media.ugaoo.com/wysiwyg/usp1.png" class="card-img-top" alt="..." />
        <div class="b3card-body">
      ...
      <div class="b3card" >
        <img src="https://media.ugaoo.com/wysiwyg/usp2.png" class="card-img-top" alt="..." />
        <div class="b3card-body">
      ...
      <div class="b3card" >
        <img src="https://media.ugaoo.com/wysiwyg/usp3.png" class="card-img-top" alt="..." />
        <div class="b3card-body">
      ...
      <div class="b3card" >
        <img src="https://media.ugaoo.com/wysiwyg/usp4.png" class="card-img-top" alt="..." />
        <div class="b3card-body">
